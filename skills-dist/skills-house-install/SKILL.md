...
description: Use when installing built skills-house dist into agent skill
  directories. Covers source/target model, install-skills CLI flags, scope, and
  the difference from skills.sh consumer installs.
metadata:
  author: al4f
  version: 0.1.0
  tags:
