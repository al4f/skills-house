...
description: Use when scaffolding a new skills-house project or bootstrapping
  the framework into a repo. Covers @skills-house/create CLI, generated layout,
  fresh-project constraints, and future .house isolation.
metadata:
  author: al4f
  version: 0.1.0
  tags:
